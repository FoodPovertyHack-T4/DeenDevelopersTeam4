...
const getAllUsers = async () => {
  const users = await fetch(`${API_BASE}/user`).then((response) =>
    response.json()
  );
...
const getAllCamps = async () => {
  const camps = await fetch(`${API_BASE}/user`).then((response) =>
    response.json()
  );
  return camps;
};
...
const getAllProvisions = async () => {
  const provisions = await fetch(
    "https://deen-developers-team4.herokuapp.com/provision"
...
const addProvisionToUser = async (jsonObj) => {
  const rawResponse = await fetch(
    "https://deen-developers-team4.herokuapp.com/provision/add",
    {
      method: "POST",
      headers: {
...
const addNotificationForPackage = async (theData) => {
  const rawResponse = await fetch(
    "https://deen-developers-team4.herokuapp.com/notification",
    {
      method: "POST",
      headers: {
        Accept: "application/json",
